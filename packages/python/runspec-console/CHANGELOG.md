...
### Fixed
- **Corrupted wheel** — `bridge.py` and `OutputPanel.tsx` were written with null bytes during the 0.1.3 build due to a stale Linux mount cache. The wheel now contains clean source files and imports correctly.
